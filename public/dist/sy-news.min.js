angular.module("ShinyaNews",["ngTouch","ngAnimate","angular-storage","ShinyaNews.stopPropagationDirective","ShinyaNews.i18nDirective","ShinyaNews.timeHelperServices"]).factory("oneDayStore",["store",function(e){return e.getNamespacedStore("one-day-news","-")}]).controller("rootController",["$scope","$http","$timeout","$window","store","oneDayStore","syNewsTimeHelper",function(e,t,s,n,o,l,a){function i(t,s,n){e.newsBox=t,e.isShow=s,e.isNewsExist=n}function c(s,n){e.isOldNews?r():w();var o,a=s.selectDate+e.selectCountry;if(n){if(1===u&&e.isHideCaretRight||-1===u&&e.isHideCaretLeft)return}else i([],!1,!0);return(o=s.isAllDay?N[a]:l.get(a))?void(n?null:i(o,!0,!0)):void t.post("/api/getSelectedDateNews",s).success(function(e,t,s,o){o.data.isAllDay?N[a]=e.msg:f(a,e.msg),n||i(e.msg,!0,!0)}).error(function(e,t,s,o){n||i([],!0,!1)})}function w(){var t=e.selectNewsInfo.selectDate;e.isHideCaretLeft=t-36e5===a.getDayMs(new Date)?!0:!1,e.isHideCaretRight=t+36e5>Date.now()?!0:!1}function r(){var t=e.selectOldNewsInfo.selectDate;e.isHideCaretLeft=!1,e.isHideCaretRight=t+1728e5>Date.now()?!0:!1}function f(e,t){l.set(e,t);var s=Date.now()+864e5;o.set("oneDayNewsExpires",a.getDayMs(s))}function D(){for(var e=n.localStorage,t=localStorage.length,s=/^one-day-news-/,l=0,a=0;t>a;a++)s.test(e.key(l))?o.remove(e.key(l)):l++}o.get("oneDayNewsExpires")<Date.now()?D():null,e.isShow=!1,e.isNewsExist=!0,e.isOldNews=!1,e.isShowTimeMachine=!1,e.toggleNews=function(){e.isOldNews=!e.isOldNews,angular.element(document.documentElement).toggleClass("oldNews"),e.refreshNews()},e.toggleTimeMachine=function(){e.timeMachineInfo={H:new Date(e.selectNewsInfo.selectDate).getHours(),M:new Date(e.selectOldNewsInfo.selectDate).getMonth()+1,D:new Date(e.selectOldNewsInfo.selectDate).getDate()},e.isShowTimeMachine=!e.isShowTimeMachine};var N={},u=-1;e.newsBox=[],e.selectCountry=o.get("syNewsCountry")||"HK",e.selectNewsInfo={selectDate:l.get("lastNewsDate")||a.getHoursMs((new Date).getHours()),selectCountry:e.selectCountry,isAllDay:!1},e.selectOldNewsInfo={selectDate:o.get("lastOldNewsDate")||a.getDayMs(Date.now())-864e5,selectCountry:e.selectCountry,isAllDay:!0},e.timeMachineInfo={H:(new Date).getHours(),M:(new Date).getMonth()+1,D:(new Date).getDate()},e.isHideCaretLeft=!1,e.isHideCaretRight=!1,e.selectNews=function(t){1===t&&e.isHideCaretRight||-1===t&&e.isHideCaretLeft||(e.isOldNews?e.selectOldNewsInfo.selectDate+=864e5*t:e.selectNewsInfo.selectDate+=36e5*t,t===u?c({selectDate:e.isOldNews?e.selectOldNewsInfo.selectDate+864e5*t:e.selectNewsInfo.selectDate+36e5*t,selectCountry:e.selectCountry,isAllDay:e.isOldNews?!0:!1},!0):u=t)},e.timeMachineSelectNews=function(){e.isOldNews?e.selectOldNewsInfo.selectDate=a.getDayMs(new Date(2015,e.timeMachineInfo.M-1,e.timeMachineInfo.D)):e.selectNewsInfo.selectDate=a.getHoursMs(e.timeMachineInfo.H),e.isShowTimeMachine=!1},e.refreshNews=function(){c(e.isOldNews?e.selectOldNewsInfo:e.selectNewsInfo)},e.$watch("selectCountry",function(t,s){t!==s&&(e.selectNewsInfo.selectCountry=t,e.selectOldNewsInfo.selectCountry=t,e.refreshNews())}),e.$watch("selectNewsInfo.selectDate",function(t,s){t!==s&&(l.set("lastNewsDate",e.selectNewsInfo.selectDate),c(e.selectNewsInfo))}),e.$watch("selectOldNewsInfo.selectDate",function(t,s){t!==s&&(o.set("lastOldNewsDate",e.selectOldNewsInfo.selectDate),c(e.selectOldNewsInfo))}),e.$watch("newsBox",function(e,t){e!==t&&(document.getElementsByClassName("newsBox__news")[0].scrollTop=0)}),w(),c(e.selectNewsInfo)}]);
