angular.module("ShinyaNews",["ngTouch","ngAnimate","ui.router","angular-storage","ShinyaNews.stopPropagationDirective","ShinyaNews.i18nDirective","ShinyaNews.fullscreenButtonDirective","ShinyaNews.timeMachineDirective","ShinyaNews.autofocusDirective","ShinyaNews.timeHelperServices","ShinyaNews.selectNewsItemServices","ShinyaNews.oneDayStoreServices","ShinyaNews.UIServices"]).config(["$locationProvider","$stateProvider","$urlRouterProvider",function(e,t,s){s.otherwise(function(){var e=new Date,t=e.getFullYear(),s=e.getMonth()+1,n=e.getDate(),o=e.getHours(),i=JSON.parse(localStorage.getItem("syNewsCountry"))||"HK";return i+"/"+t+"/"+s+"/"+n+"?h="+o}),e.html5Mode(!0),t.state("country",{"abstract":!0,url:"/{country:BR|CN|DE|FR|HK|IN|JP|KR|RU|TW|US}",template:"<div ui-view></div>",controller:["$scope","$stateParams",function(e,t){e.saveCountry(t.country)}]}).state("date",{parent:"country",url:"/{year:201[5-6]}/{month:0?[1-9]|1[0-2]}/{day:0?[0-9]|[12][0-9]|3[0-1]}?h&q",templateUrl:"/public/dist/newsBox.min.html",controller:["$scope","$location","$stateParams","store","syNewsTimeHelper",function(e,t,s,n,o){var i=s.year,a=s.month,l=s.day,r=s.h;e.search.title=s.q,o.isToday(i,a,l)?(r>0&&24>=r?null:t.path("/"),e.selectNewsInfo.selectDate=o.toHourMs(i,a,l,r)):(e.selectOldNewsInfo.selectDate=o.toDayMs(i,a,l),n.set("lastOldNewsDate",e.selectOldNewsInfo.selectDate),e.isOldNews?null:e.toggleNews()),e.refreshNews()}]})}]).factory("oldNewsCache",["$cacheFactory",function(e){return e("oldNewsCache")}]).controller("rootController",["$scope","$http","$timeout","$window","$state","$stateParams","store","oldNewsCache","syNewsTimeHelper","sySelectNewsItem","syOneDayStore","syUI",function(e,t,s,n,o,i,a,l,r,c,w,u){function g(t,s,n){e.newsBox=t,e.isShow=s,e.isNewsExist=n}function d(s,n){e.isOldNews?N():h();var o,i=s.selectDate+e.selectCountry;if(n){if(1===y&&e.isHideCaretRight||-1===y&&e.isHideCaretLeft)return}else g([],!1,!0),e.isNewsDone=!1,w.get(i+"-Done")?e.isNewsDone=!0:e.isOldNews||(w.set(i+"-Done",!0),e.isNewsDone=!1);return(o=s.isAllDay?l.get(i):w.get(i))?void(n?null:g(o,!0,!0)):void t.post("/api/getSelectedDateNews",s).success(function(e,t,s,o){o.data.isAllDay?l.put(i,e.msg):w.set(i,e.msg),n||g(e.msg,!0,!0)}).error(function(e,t,s,o){n||g([],!0,!1)})}function h(){var t=e.selectNewsInfo.selectDate;e.isHideCaretLeft=t-36e5===r.getDayMs(new Date)?!0:!1,e.isHideCaretRight=t+36e5>Date.now()?!0:!1}function N(){var t=e.selectOldNewsInfo.selectDate;e.isHideCaretLeft=!1,e.isHideCaretRight=t+1728e5>Date.now()?!0:!1}a.get("oneDayNewsExpires")<Date.now()?w.removeAll():null,e.isShow=!1,e.isNewsExist=!0,e.isOldNews=!1,e.isShowTimeMachine=!1,e.toggleNews=function(){if(u.toggleBGC(),u.cardFlip(),e.isOldNews){var t=new Date(e.selectNewsInfo.selectDate||r.getHoursMs((new Date).getHours()));o.go("date",{year:t.getFullYear().toString(),month:(t.getMonth()+1).toString(),day:t.getDate().toString(),h:t.getHours().toString(),q:null})}else{var s=new Date(e.selectOldNewsInfo.selectDate||r.getDayMs(Date.now())-864e5);o.go("date",{year:s.getFullYear().toString(),month:(s.getMonth()+1).toString(),day:s.getDate().toString(),h:null,q:i.h?null:i.q})}e.isOldNews=!e.isOldNews},e.updateQueryParam=function(e){o.go("date",{q:e},{notify:!1,reload:!0})};var y=-1;e.newsBox=[],e.selectCountry=a.get("syNewsCountry")||"HK",e.selectNewsInfo={selectDate:0,selectCountry:e.selectCountry,isAllDay:!1},e.selectOldNewsInfo={selectDate:a.get("lastOldNewsDate"),selectCountry:e.selectCountry,isAllDay:!0},e.timeMachineInfo={},e.search={},e.isHideCaretLeft=!1,e.isHideCaretRight=!1,e.selectNews=function(t){if(u.toggleDirection(t),!(1===t&&e.isHideCaretRight||-1===t&&e.isHideCaretLeft)){if(e.isOldNews){var s=r.getDateObj(e.selectOldNewsInfo.selectDate+864e5*t);o.go("date",{month:s.month,day:s.day,h:null,q:null})}else o.go("date",{h:(parseInt(i.h?i.h:(new Date).getHours())+t).toString(),q:null});t===y?d({selectDate:e.isOldNews?e.selectOldNewsInfo.selectDate+1728e5*t:e.selectNewsInfo.selectDate+72e5*t,selectCountry:e.selectCountry,isAllDay:e.isOldNews?!0:!1},!0):y=t,c.reset()}},e.timeMachineSelectNews=function(t){if(e.isOldNews)e.timeMachineInfo.M<=i.month&&e.timeMachineInfo.D<=i.day?u.toggleDirection(-1):u.toggleDirection(1),o.go("date",{year:"20"+e.timeMachineInfo.Y,month:e.timeMachineInfo.M,day:e.timeMachineInfo.D,h:null,q:null});else{var s=t?-1===t?1:(new Date).getHours():e.timeMachineInfo.H;s<=i.h?u.toggleDirection(-1):u.toggleDirection(1),o.go("date",{h:s,q:null})}e.isShowTimeMachine=!1},e.refreshNews=function(){d(e.isOldNews?e.selectOldNewsInfo:e.selectNewsInfo)},e.$watch("search.title",function(e,t){e!==t&&o.go("date",{q:e},{notify:!1,reload:!0})}),n.addEventListener("keydown",function(t){if("input"!==t.target.tagName.toLowerCase()){var s=t.keyCode;37===s?e.selectNews(-1):39===s?e.selectNews(1):38===s?c.go(-1):40===s?c.go(1):null}})}]);
angular.module("ShinyaNews.autofocusDirective",[]).directive("syNewsAutofocus",function(){return{restrict:"A",link:function(u,e,i){e[0].focus()}}});
